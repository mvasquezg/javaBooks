...
void main(){
    ...
    for(int i=0; i<lengthArray; i++){
        ...
        do{
            printf("%d.-Ingrese calificacion: ", (i+1));
                scanf("%d", &arrayQualification[i]);
        ...
        printf("\nTotal de alumnos aprobados: %d",cal6);
        printf("\n\nTotal de alumnos reprobados: %d", cal);
        printf("\n\nTotal de alumnos con calificacion mayor a 8: %d", cal8);
        printf("\n\nPorcentaje de alumnos aprobados: %d\nPorcentaje de alumnos reprobados: %d\n\n", averageApro, averageRepro);
}